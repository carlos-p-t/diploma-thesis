...
\compscifalse{} % applied informatics
...
\newcommand{\thesisname}{Evaluating the significance of outdoor advertising utilizing Computer Vision}

% If you are writing a master's thesis, don't forget to add Bc. here.
\newcommand{\thesisauthor}{Bc. Carlos Andres Pizarroso Troncoso}

\newcommand{\thesissupervisor}{RNDr. Zuzana Berger Haladová, PhD.}
...
\newcommand{\thesiskeywordssk}{Keywords}

\newcommand{\thesiskeywordsen}{Keywords}

\newcommand{\thesischapters}{
    \input chapters/00-introduction.tex
    \input chapters/10-literature_review.tex
    \input chapters/20-data.tex
    \input chapters/30-methodology.tex
    \input chapters/40-results.tex
    \input chapters/50-discussion.tex
...
\ifenglish{}
    ...
    \else
        \newcommand{\thesisfield}{Computer Science}
        \newcommand{\thesisprogramme}{Applied Computer Science}
    \fi
